...
const userSchema = new mongoose.Schema(
  {
    ...
    wishlist: [{ type: mongoose.Schema.Types.ObjectId, ref: "Item" }],  // 👈 Wishlist de Items
    personalCollection: [{ type: mongoose.Schema.Types.ObjectId, ref: "Release" }],  // 👈 Colección Personal de Releases
    cart: [{ type: mongoose.Schema.Types.ObjectId, ref: "Item" }],  // 👈 Carrito de Compra de Items
  },
  {
    timestamps: true,
    toJSON: {
